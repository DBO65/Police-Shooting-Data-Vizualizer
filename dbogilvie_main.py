...
print(f"\nOut of the population of individuals fleeing a fatal police shooting while armed {waf_data*100:.2f}%\n"
      ...
      f"and {uaf_data*100:.2f}% were Unknown,")
...
print(f"\nIn contrast out of all the fatal police shootings that occurred in 2015, {c_waf_data*100:.2f}%\n"
      ...
      f"and {c_uaf_data*100:.2f}% were Unknown")

# Create and Display bar chart
x = ['White', 'African-American', 'Asian', 'Hispanic', 'Native American', 'Unknown']
y = [w_af_data*100, b_af_data*100, a_af_data*100, h_af_data*100, na_af_data*100, u_af_data*100]
...
# Create and Display bar chart
x = ['White', 'African-American', 'Asian', 'Hispanic', 'Native American', 'Unknown']
y = [waf_data*100, baf_data*100, aaf_data*100, haf_data*100, _na_af_data*100, uaf_data*100]
plt.bar(x, y, width=1, edgecolor='white', linewidth=0.7)
plt.title('Bar Graph Showing the Percentage of Individuals Fleeing While Armed in Fatal Police Shootings'
...
# Create and Display bar chart
x = ['White', 'African-American', 'Asian', 'Hispanic', 'Native American', 'Unknown']
y = [c_waf_data*100, c_baf_data*100, c_aaf_data*100, c_haf_data*100, c_naf_data*100, c_uaf_data*100]
plt.bar(x, y, width=1, edgecolor='white', linewidth=0.7)
